...
namespace UnityODE
{
    [AddComponentMenu("ODE/Motors/MotorLinear")]
    [RequireComponent(typeof(OdeJointSlider))]
    public class OdeMotorLinear : MonoBehaviour, IMotor
    {
        #region Inspector
        ...
        public OdeJointSlider Joint { get { return _joint; } }
        private OdeJointSlider _joint;
        ...
        private void Start()
        {
            _joint = GetComponent<OdeJointSlider>();
        }
        ...
        protected void BeforeSimStep()
        {
            ...
            _joint.AddForce(_axisTorque / KL);
        }
